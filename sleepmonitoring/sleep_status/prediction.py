...
class Prediction:
    ...
    facial_landmarks_predictor = 'C:/Users/sarar/PycharmProjects/Tese_de_Mestrado/sleepmonitoring/classifiers/68_face_landmarks_predictor.dat'
    predictor = dlib.shape_predictor(facial_landmarks_predictor)

    model = load_model('C:/Users/sarar/PycharmProjects/Tese_de_Mestrado/sleepmonitoring/classifiers/weights.149-0.01.hdf5')
    ...
    def sleepstatus(self, frame):
        ...
        if len(face_locations):
            ...
            if left_eye_open == 'yes' and right_eye_open == 'yes':
                ...
                eyes = 2
            elif left_eye_open == 'no' and right_eye_open == 'no':
                eyes = 3
                

            #face_box = str(x1) + ', ' + str(y1) + ', ' + str(x2) + ', ' + str(y2)

        return (x1, y1, x2, y2), eyes
