...
ap.add_argument("-v", "--video", help="Vídeo de Input", default="C:/Users/sarar/PycharmProjects/Tese_de_Mestrado_Imagem/sleepmonitoring/data/input/Crianca/Claro/video_9.webm")
...
out = cv2.VideoWriter('C:/Users/sarar/PycharmProjects/Tese_de_Mestrado_Imagem/sleepmonitoring/data/output/video_9.webm', fourcc, vs.get(cv2.CAP_PROP_FPS), (frame_width, frame_height), 1)
...
f_prediction = open("C://Users//sarar//PycharmProjects//Tese_de_Mestrado_Imagem//sleepmonitoring//evaluation//testes//video_9//prediction.txt", "w+")
...
while True:
    ...
    frame = cv2.addWeighted(frame, 4, cv2.GaussianBlur(frame, (21, 21), 0), -3, 160)
    ...
    if (frameId % math.floor(frameRate) == 0):
        ...
        cv2.imwrite('C://Users//sarar//PycharmProjects//Tese_de_Mestrado_Imagem//sleepmonitoring//evaluation//testes//video_9//predicoes//frame' + str(i) + '.jpg', frame)
        out.write(frame)
        i += 1
