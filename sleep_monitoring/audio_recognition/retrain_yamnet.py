...
yamnet_model_handle = '../../models/yamnet_1'
...
tflite_models_dir = "../../models/teste"
...
parser.add_argument('-d', '--dataset', dest='datasets_path',
                    default='../../data/dataset/', help='Invalid path to datasets!')
args = parser.parse_args()
DATASETS_PATH = args.datasets_path

files_csv = DATASETS_PATH + DATASET_NAME + '/meta/esc50.csv'
...
def plot_accuracy_loss(history):
    ...
    plt.savefig('retraining_epoch_progress.png')
    plt.show()
