...
ext = 'webm'
video_path = "../../data/input/videos/" + video + "." + ext
pred_file_path = "../../evaluation/testes/" + video + "/prediction.txt"
gt_file_path = "../../evaluation/testes/" + video + "/anotacoes/rosto/gt.txt"
